...
class Carbon_Container_CommentMeta extends Carbon_Container {
	...
	function __construct($title) {
		...
		if ( !$this->get_datastore() ) {
			$this->set_datastore(new Carbon_DataStore_CommentMeta());
		}
	}
	...
	function render() {
		include dirname(__FILE__) . '/admin-templates/container-comment-meta.php';
	}
